...
States: `DISARMED → ARMING (3 s) → ARMED → INTRUSION_PENDING (3 s) → ALARMING`.  
...
- INTRUSION_PENDING: fast red (3 s grace); ALARMING: rapid red + buzzer.
...
## Test Modes
`RUN_TEST_MODE`: 1=LEDs, 2=Buzzer, 3=Ultrasonic (cm), 4=LDR (A0), 0=Normal.
